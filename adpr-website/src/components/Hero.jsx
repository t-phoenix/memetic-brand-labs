            ...
            <div className="container">
                <div className="row align-items-center justify-content-end">
                    <div className="col-md-12">
                        <p className="mb-12 sub-heading" style={{ fontSize: '1.2rem', marginBottom: '1.6rem', fontWeight: '300' }}>
                        ...
                        <div>
                            ...
                            <p style={{ textAlign: 'center', marginTop: '40px', color: '#fff', fontSize: '1.1rem', fontWeight: '200' }}>
                                Check out our new initiative <a href="https://memetic.adpr.work/" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', textDecoration: 'underline', textDecorationColor: '#fff' }}>adpr Memetic Brand Labs</a>
                            </p>
                        </div>
                    </div>
                </div>
